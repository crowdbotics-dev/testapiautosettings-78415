...
## Project Structure
    ...
    ├── testapiautosettings_78415  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_78415`
...
2. Clone this repo and `cd testapiautosettings_78415`
